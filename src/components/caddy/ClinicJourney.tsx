...
const WIDE: Layout = {
  ...
  height: 1240,
  cards: {
    caddy: { left: 400, top: 620 },
    answers: { left: 1120, top: 70 },
    doctor: { left: 1120, top: 620 },
    slot: { left: 1120, top: 1170 },
    booked: { left: 1790, top: 620 },
    queue: { left: 2440, top: 620 },
    arrive: { left: 3040, top: 620 },
  },
  startDot: { left: 120, top: 620 },
  startPill: { left: 120, top: 420 },
  endDot: { left: 3380, top: 620 },
  endPill: { left: 3380, top: 420 },
  midDots: [
    { left: 700, top: 620 },
    { left: 1500, top: 620 },
  ],
  paths: [
    "M 120 620 L 250 620",
    "M 550 620 L 700 620",
    "M 700 620 C 830 620, 850 70, 970 70",
    "M 700 620 L 970 620",
    "M 700 620 C 830 620, 850 1170, 970 1170",
    "M 1270 70 C 1380 70, 1400 620, 1500 620",
    "M 1270 620 L 1500 620",
    "M 1270 1170 C 1380 1170, 1400 620, 1500 620",
    "M 1500 620 L 1620 620",
    "M 1940 620 L 2290 620",
    "M 2590 620 L 2890 620",
    "M 3190 620 L 3380 620",
  ],
};
